...
alter table headerchildelement
    owner to root;
...
INSERT INTO headerchild (id, created_at, updated_at, icon, name, state, type, header_id)
...
INSERT INTO headerchildelement (id, created_at, updated_at, icon, name, state, query_state, type, child_id)
